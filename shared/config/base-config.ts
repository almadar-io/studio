...
const SITE_ICONS: Record<string, { logo: string; favicon: string }> = {
  ...
  orb: { logo: "img/icon-orb-avl.svg", favicon: "img/icon-orb-avl.svg" },
  studio: { logo: "img/icon-studio-avl.svg", favicon: "img/icon-studio-avl.svg" },
  services: { logo: "img/icon-services-avl.svg", favicon: "img/icon-services-avl.svg" },
